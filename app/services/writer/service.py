...
1. **开头**（1-2段）：直接交代事件核心事实——谁、做了什么、什么结果。引用素材来源。不铺垫、不渲染。
2. **中段**：你的分析和判断。不要列分论点编号，用自然行文推进。每段只说一件事，说完就走，不回头。关键判断可以用**加粗短句**强调。
3. **结尾**（1段）：金句收尾或反问留白。不总结、不复述。
...
- 短文：500-700字（宁短勿水，写到500字观点说完了就收）
- 长文：700-1000字
- 中文汉字计，标点不计
